...
import scripts.ContentTweaker.Materials.ore.materialList;
import scripts.ContentTweaker.Items.default.registerItemNames;
import scripts.ContentTweaker.Blocks.default.registerBlocks;
