...
em.setDurationSlot(6, 2)
    .setGroup("time")
    .setVisual(SlotVisual.arrowRight());

em.setItemSlot(0, 2, allFace, 64)
    .setGroup("input0")
    .setAccess(true, false);

em.setItemSlot(2, 0, allFace, 64)
    .setGroup("input1")
    .setAccess(true, false);

em.setItemSlot(2, 4, allFace, 64)
    .setGroup("input2")
    .setAccess(true, false);

em.setItemSlot(4, 2, allFace, 64)
    .setGroup("input3")
    .setAccess(true, false);

em.setFluidSlot(8, 4, allFace, 1000)
    .setGroup("output")
    .setAccess(false, true)
    .allowBucket(false, true)
    .pushFluid(100);

em.setItemSlot(8, 2, allFace, 64)
    .setGroup("output")
    .setAccess(false, true)
